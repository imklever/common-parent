...
public class RandomValidateCodeUtils {
	 ...
	 *   * 生成随机图片   
	 */
	public void getRandcode(String sid,long expiredTime,HttpServletResponse response) {
		...
		g.setFont(new Font("宋体", Font.BOLD, 20));// 字体大小
		...
		map.put("expiredTime", overduetime);
		BaseConfig.VALIDATE_CODE_HASH_MAP.put("valid_code_"+sid, map);
