...
import com.isoftstone.common.BackupApplication;
...
@ComponentScan(basePackageClasses = BackupApplication.class)
@MapperScan(basePackages = { "com.isoftstone.common.backup.mapper","com.isoftstone.common.mapper" })
