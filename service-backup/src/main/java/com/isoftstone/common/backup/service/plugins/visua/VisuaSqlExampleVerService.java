...
public interface VisuaSqlExampleVerService extends BaseService<VisuaSqlExampleVer, String> {

/*	VisuaSqlExampleVer getByBusinessCode(String businesscode);

	int getByBusinessCodeCount(String businessCode);

	Map<String, Object> getByDataBusinessCode(String businesscode, String params);

	List<VisuaSqlExampleVer> findBySel(String VisuaSqlExampleVer, List<String> sort);
	...
	PageInfo<VisuaSqlExampleVer> findByPage(String VisuaSqlExampleVer, Integer pageNo, Integer pageSize, List<String> sort);

	Map<String, Object> getDataByOneToMany(String businessCode, String params);

	List<VisuaSqlExampleVer> findByUserId(String userId);

	PageInfo<Map<String, Object>> getDataByOneToManyByPage(String businessCode, String params, Integer page, Integer size,
			List<String> sort);*/

	int saveVersion(VisuaSqlExampleVer findById);
}
